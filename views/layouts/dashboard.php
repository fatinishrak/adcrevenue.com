    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar">            
            <section class="sidebar">                
				...
				<?php if($userId === 17) { ?>
					<ul class="sidebar-menu">
						<li class="header">মোকাদ্দমা সমুহের তালিকা</li>				
						<li class="treeview">
				...
				<?php } else { ?>
					<div id="TopMenu">
					  <div class="list-group panel" style="color:#222D32; background:#222d32;">
						<a href="#adalot" class="list-group-item list-group-item-primary"  data-toggle="collapse" data-parent="#TopMenu"><h6>বিজ্ঞ আদালত ভিত্তিক মোকাদ্দমা সমুহের তালিকা</h6></a>
						...
						<a href="#upazila" class="list-group-item list-group-item-primary" data-toggle="collapse" data-parent="#TopMenu"><h6>উপজেলাভিত্তিক মোকাদ্দমা সমুহের তালিকা</h6></a>
